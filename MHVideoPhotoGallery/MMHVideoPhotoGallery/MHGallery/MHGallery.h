...
extern NSString *const MHYoutubeHQThumbBaseURL;
extern NSString *const MHYoutubeMQThumbBaseURL;
extern NSString *const MHYoutubeSDThumbBaseURL;
extern NSString *const MHYoutubeMaxThumbBaseURL;
